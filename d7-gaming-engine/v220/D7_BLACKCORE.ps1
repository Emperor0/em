...
LoadGames
$form=New-Object Windows.Forms.Form;$form.Text='D7 BLACKCORE v2.2.0';$form.Size=New-Object Drawing.Size(1120,720);$form.StartPosition='CenterScreen';$form.BackColor=[Drawing.Color]::FromArgb(8,10,12);$form.ForeColor=[Drawing.Color]::White
...
$sub=New-Object Windows.Forms.Label;$sub.Text='BLACKSCAN -> FRAME LAB -> A/B -> TUNE -> VERIFY -> ROLLBACK';$sub.Font=New-Object Drawing.Font('Consolas',10);$sub.ForeColor=[Drawing.Color]::DeepSkyBlue;$sub.AutoSize=$true;$sub.Location=New-Object Drawing.Point(33,70);$form.Controls.Add($sub)
