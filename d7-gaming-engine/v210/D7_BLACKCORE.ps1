...
LoadGames
$form=New-Object Windows.Forms.Form;$form.Text='D7 BLACKCORE v2.1';$form.Size=New-Object Drawing.Size(1120,720);$form.StartPosition='CenterScreen';$form.BackColor=[Drawing.Color]::FromArgb(8,10,12);$form.ForeColor=[Drawing.Color]::White
